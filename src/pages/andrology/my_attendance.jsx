...
export default function MyAttendance() {
	...
	const fetchData = async () => {
		setLoading(true);
		try {
			const todayRes = await AndrologyApi.getTodayAttendance().catch(() => null);
			const histRes  = await AndrologyApi.getAttendanceHistory({}).catch(() => null);
			const statsRes = await AndrologyApi.getAttendanceStats({}).catch(() => null);
	...
	const handleCheckIn = async () => {
		...
		try {
			await AndrologyApi.markAttendance(payload);  // POST
			await fetchData();
		} catch (e) {
	...
	const handleCheckOut = async () => {
		...
		try {
			await AndrologyApi.updateAttendance(payload);  // PUT
			await fetchData();
		} catch (e) {
