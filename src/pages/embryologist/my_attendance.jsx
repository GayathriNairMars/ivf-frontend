...
export default function MyAttendance() {
	...
	const fetchData = async () => {
		setLoading(true);
		try {
			const todayRes = await embryologistApi.getTodayAttendance().catch(() => null);
			const histRes  = await embryologistApi.getAttendanceHistory({}).catch(() => null);
			const statsRes = await embryologistApi.getAttendanceStats({}).catch(() => null);
	...
	const handleCheckIn = async () => {
		...
		try {
			await embryologistApi.markAttendance(payload);  // POST
			await fetchData();
		} catch (e) {
	...
	const handleCheckOut = async () => {
		...
		try {
			await embryologistApi.updateAttendance(payload);  // PUT
			await fetchData();
		} catch (e) {
