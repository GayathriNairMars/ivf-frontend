...
import "./pharmacist_attendance.css";
...
export default function PharmacistAttendance() {
	...
	const fetchData = async () => {
		setLoading(true);
		try {
			const todayRes = await pharmacistApi.getTodayAttendance().catch(() => null);
			const histRes  = await pharmacistApi.getAttendanceHistory({}).catch(() => null);
			const statsRes = await pharmacistApi.getAttendanceStats({}).catch(() => null);
	...
	const handleCheckIn = async () => {
		...
		try {
			await pharmacistApi.markAttendance(payload);  // POST
			await fetchData();
		} catch (e) {
	...
	const handleCheckOut = async () => {
		...
		try {
			await pharmacistApi.updateAttendance(payload);  // PUT
			await fetchData();
		} catch (e) {
