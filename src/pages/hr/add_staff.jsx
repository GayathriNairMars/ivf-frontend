...
export default function AddStaffHR({onDone}) {
	const [form, setForm] = useState({
	    name: "", email: "", role: "HRM", password: "", is_active: true,
	    date_of_birth: "", employee_id: "", contact_number: ""
	});
...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (primaryDept?.id) {
            payload.append("department_id", primaryDept.id);
        }
