...
import { ROLES,ROLE_PERMISSIONS,ROLE_DEFAULT_DEPT_CODE } from "../../../../utils/constants";
import { useNavigate } from "react-router-dom";
import { ROLE_SECONDARY_DEPTS,DEPARTMENT_UNITS } from "../../../../utils/constants";
...
export default function AddStaff() {
  ...
  const handleSubmit = async(e) => {
    ...
    await api.post("/staff-management/",payload,{
